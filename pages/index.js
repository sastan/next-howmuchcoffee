...
import { fetchAllUsers } from '@query'

import PageHeading from '../components/PageHeading'

const Index = ({ dehydratedData }) => {
  const { isLoading, error, data } = useQuery('fetchAllUsers', fetchAllUsers, {
...
export async function getStaticProps() {
  ...
  await queryCache.prefetchQuery('fetchAllUsers', fetchAllUsers)

  return {
    props: {
      dehydratedData: dehydrate(queryCache),
    },
  }
}
